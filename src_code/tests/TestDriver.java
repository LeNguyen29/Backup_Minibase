...
public class TestDriver {
  ...
  protected TestDriver(String nameRoot) {
    ...
    // dependent.
    dbpath = "D:\\RRGS\\Backup_Minibase\\src_code\\test\\" + nameRoot + System.getProperty("user.name") + ".minibase-db";
    logpath = "D:\\RRGS\\Backup_Minibase\\src_code\\test\\" + nameRoot + System.getProperty("user.name") + ".minibase-log";
  }
  ...
  protected boolean runAllTests() {
    ...
    System.out
        .println("After " + testName() + " Test 1 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    ...
    System.out
        .println("After " + testName() + " Test 2 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    ...
    System.out
        .println("After " + testName() + " Test 3 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    ...
    System.out
        .println("After " + testName() + " Test 4 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    ...
    System.out
        .println("After " + testName() + " Test 5 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    ...
    System.out
        .println("After " + testName() + " Test 6 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
